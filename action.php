...
if(isset($_POST["category"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked' style='background: black;'>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="dkvasu77@gmail.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/vgbd/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/vgbd/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/vgbd/cancel.php"/>
